...
dir_qd = paste0(path,"/cran_gen/cran_package/src/external/qd_src/include")
files= list.files(dir_qd)
qd_dist = (paste0(path,"/cran_gen/cran_package/src/external/qd"))
file.copy(file.path(dir_qd,files), qd_dist)
dir_qd = paste0(path,"/cran_gen/cran_package/src/external/qd_src/run_headers")
files= list.files(dir_qd)
