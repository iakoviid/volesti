...
void run_main(int n_samples = 10000, int n_burns = -1, int dimension = 2,
  ...
  using Func = CustomFunctor::FunctionFunctor<Point>;
  using Grad = CustomFunctor::GradientFunctor<Point>;
  using Hess =  CustomFunctor::HessianFunctor<Point>;
  using func_params = CustomFunctor::parameters<NT>;
